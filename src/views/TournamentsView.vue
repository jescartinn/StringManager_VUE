      ...
      <v-container class="tournaments-view__container">
        ...
        <v-row class="mb-3">
          ...
          <v-col cols="12" sm="4" class="d-flex justify-end align-center">
            <v-btn v-if="canManageTournaments" class="mb-3" color="primary" prepend-icon="mdi-plus" @click="openNewTournamentDialog">
              New Tournament
            </v-btn>
          </v-col>
        </v-row>
        ...
        <v-card v-if="!loading && filteredTournaments.length === 0" class="mb-6 text-center py-8">
          ...
          <v-btn v-if="canManageTournaments" color="primary" prepend-icon="mdi-plus" @click="openNewTournamentDialog">Add New Tournament</v-btn>
        </v-card>
